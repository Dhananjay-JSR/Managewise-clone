...
export function Integrations() {
  ...
  const y2 = useTransform(scrollYProgress, [0, 0.7], [0, 100]);
  return (
    <div ref={ref} className="bg-[#1c1c1c] relative">
      <div className="absolute  2xl:block hidden h-full w-full">
        <div className="w-full h-full  relative">
          <motion.svg
            ...
            height="40"
            fill="currentColor"
            className="bi bi-amd fill-white absolute top-[100px] left-[420px]"
            viewBox="0 0 16 16"
          >
          ...
          <motion.svg
            ...
            height="40"
            fill="currentColor"
            className="bi bi-android2 fill-white absolute top-[170px] right-[420px]"
            viewBox="0 0 16 16"
          >
          ...
          <motion.svg
            ...
            height="40"
            fill="currentColor"
            className="bi bi-database-fill fill-white absolute top-[350px] left-[300px]"
            viewBox="0 0 16 16"
          >
          ...
          <motion.svg
            ...
            height="40"
            fill="currentColor"
            className="bi bi-layer-backward fill-white absolute top-[470px] right-[300px]"
            viewBox="0 0 16 16"
          >
      ...
      <section className="2xl:max-w-[1200px] max-w-[1050px] mx-auto">
        ...
        <div className="mx-auto w-fit mt-3">
          <h2
            className={"text-[#fdf2ec] text-[36px] md:text-[45px] 2xl:text-[56px] w-full px-3 md:px-0 md:w-[600px] font-medium leading-none text-center " +
              outfir.className}
          >
        ...
        <div
          className={"text-[#767575] text-[18px] md:text-[20px] font-medium w-full px-3 md:px-0 md:w-[450px] mx-auto mt-5 text-center " +
            inter.className}
        >
        ...
        <div className="flex  gap-8 mx-auto 2xl:hidden w-fit mt-4">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="40"
            height="40"
            fill="currentColor"
            className="bi bi-amd fill-white "
            viewBox="0 0 16 16"
          >
            <path d="m.334 0 4.358 4.359h7.15v7.15l4.358 4.358V0H.334ZM.2 9.72l4.487-4.488v6.281h6.28L6.48 16H.2V9.72Z" />
          </svg>
          ...
          <svg
            ...
            height="40"
            fill="currentColor"
            className="bi bi-android2 fill-white "
            viewBox="0 0 16 16"
          >
            <path d="m10.213 1.471.691-1.26c.046-.083.03-.147-.048-.192-.085-.038-.15-.019-.195.058l-.7 1.27A4.832 4.832 0 0 0 8.005.941c-.688 0-1.34.135-1.956.404l-.7-1.27C5.303 0 5.239-.018 5.154.02c-.078.046-.094.11-.049.193l.691 1.259a4.25 4.25 0 0 0-1.673 1.476A3.697 3.697 0 0 0 3.5 5.02h9c0-.75-.208-1.44-.623-2.072a4.266 4.266 0 0 0-1.664-1.476ZM6.22 3.303a.367.367 0 0 1-.267.11.35.35 0 0 1-.263-.11.366.366 0 0 1-.107-.264.37.37 0 0 1 .107-.265.351.351 0 0 1 .263-.11c.103 0 .193.037.267.11a.36.36 0 0 1 .112.265.36.36 0 0 1-.112.264m4.101 0a.351.351 0 0 1-.262.11.366.366 0 0 1-.268-.11.358.358 0 0 1-.112-.264c0-.103.037-.191.112-.265a.367.367 0 0 1 .268-.11c.104 0 .19.037.262.11a.367.367 0 0 1 .107.265c0 .102-.035.19-.107.264M3.5 11.77c0 .294.104.544.311.75.208.204.46.307.76.307h.758l.01 2.182c0 .276.097.51.292.703a.961.961 0 0 0 .7.288.973.973 0 0 0 .71-.288.95.95 0 0 0 .292-.703v-2.182h1.343v2.182c0 .276.097.51.292.703a.972.972 0 0 0 .71.288.973.973 0 0 0 .71-.288.95.95 0 0 0 .292-.703v-2.182h.76c.291 0 .54-.103.749-.308.207-.205.311-.455.311-.75V5.365h-9v6.404Zm10.495-6.587a.983.983 0 0 0-.702.278.91.91 0 0 0-.293.685v4.063c0 .271.098.501.293.69a.97.97 0 0 0 .702.284c.28 0 .517-.095.712-.284a.924.924 0 0 0 .293-.69V6.146a.91.91 0 0 0-.293-.685.995.995 0 0 0-.712-.278m-12.702.283a.985.985 0 0 1 .712-.283c.273 0 .507.094.702.283a.913.913 0 0 1 .293.68v4.063a.932.932 0 0 1-.288.69.97.97 0 0 1-.707.284.986.986 0 0 1-.712-.284.924.924 0 0 1-.293-.69V6.146c0-.264.098-.491.293-.68Z" />
          </svg>
          ...
          <svg
            ...
            height="40"
            fill="currentColor"
            className="bi bi-database-fill fill-white "
            viewBox="0 0 16 16"
          >
            <path d="M3.904 1.777C4.978 1.289 6.427 1 8 1s3.022.289 4.096.777C13.125 2.245 14 2.993 14 4s-.875 1.755-1.904 2.223C11.022 6.711 9.573 7 8 7s-3.022-.289-4.096-.777C2.875 5.755 2 5.007 2 4s.875-1.755 1.904-2.223Z" />
            <path d="M2 6.161V7c0 1.007.875 1.755 1.904 2.223C4.978 9.71 6.427 10 8 10s3.022-.289 4.096-.777C13.125 8.755 14 8.007 14 7v-.839c-.457.432-1.004.751-1.49.972C11.278 7.693 9.682 8 8 8s-3.278-.307-4.51-.867c-.486-.22-1.033-.54-1.49-.972" />
          ...
          <svg
            ...
            height="40"
            fill="currentColor"
            className="bi bi-layer-backward fill-white "
            viewBox="0 0 16 16"
          >
            <path d="M8.354 15.854a.5.5 0 0 1-.708 0l-3-3a.5.5 0 0 1 0-.708l1-1a.5.5 0 0 1 .708 0l.646.647V4H1a1 1 0 0 1-1-1V1a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1H9v7.793l.646-.647a.5.5 0 0 1 .708 0l1 1a.5.5 0 0 1 0 .708l-3 3z" />
            <path d="M1 9a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h4.5a.5.5 0 0 1 0 1H1v2h4.5a.5.5 0 0 1 0 1zm9.5 0a.5.5 0 0 1 0-1H15V6h-4.5a.5.5 0 0 1 0-1H15a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1z" />
