        ...
        <div className="space-y-12 ">
          ...
          <div className="relative w-fit  mx-auto">
            <Image
              className="absolute"
              src={
                "https://framerusercontent.com/images/584hzJDnWCS5SFABKjaCzgDspY.png?scale-down-to=512"
              }
              alt="Overlay"
              width={440}
              height={170}
            ...
            <Image
              src={
                "https://framerusercontent.com/images/S4kVG1FFzSqxr8zOqpvJRfsBad0.png?scale-down-to=512"
              }
              alt="Overlay Emoji"
              width={440}
              height={170}
...
function LinksItems({ children }: { children: React.ReactNode }) {
  return (
    <Link
      href={"/"}
      className={
        "text-[16px] font-medium hover:text-[#767575] " + inter.className
      }
    >
      {children}
    </Link>
